...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.qtVersionLabel = QLabel(Dialog)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(QCoreApplication.translate("Dialog", u"\u7248\u672c ", None))
        self.qtVersionLabel.setText(QCoreApplication.translate("Dialog", u"v2.0.2", None))
